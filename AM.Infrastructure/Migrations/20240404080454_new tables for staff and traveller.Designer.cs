...
namespace AM.Infrastructure.Migrations
{
    ...
    [Migration("20240404080454_new tables for staff and traveller")]
    partial class newtablesforstaffandtraveller
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AM.ApplicationCore.Domain.Staff", b =>
                {
                    b.HasOne("AM.ApplicationCore.Domain.Passenger", null)
                        .WithOne()
                        .HasForeignKey("AM.ApplicationCore.Domain.Staff", "PassporitNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AM.ApplicationCore.Domain.Traveller", b =>
                {
                    b.HasOne("AM.ApplicationCore.Domain.Passenger", null)
                        .WithOne()
                        .HasForeignKey("AM.ApplicationCore.Domain.Traveller", "PassporitNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
