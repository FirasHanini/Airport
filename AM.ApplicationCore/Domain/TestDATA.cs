...
namespace AM.ApplicationCore.Domain
{
    public class TestDATA
    {
       ...
       ,
        ...
        public static Flight flight2 = new Flight { Departure="Tunis",FlightDate = new DateTime(2022, 02, 01, 21, 10, 10), Destination = "Paris", EffectiveArrival = new DateTime(2022, 02, 01, 23, 10, 10), EstimatedDuration = 105, myPlane = BoingPlane };
